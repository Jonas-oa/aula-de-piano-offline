# Política do catálogo musical

1. O aplicativo não inclui letras nesta primeira versão.
2. As sequências internas são trechos didáticos simplificados e transcritos para o projeto.
3. Antes de adicionar uma obra, conferir separadamente:
   - direitos da composição;
   - direitos da letra e de traduções;
   - direitos da edição, gravação, MIDI, MusicXML ou arranjo utilizado;
   - situação jurídica no país de distribuição.
